...
public class MyData {
    final static String[] soutMenu = {"1 - Arraylist, 2 - LinkedList; 3 - Map; 4 - Set;","please enter your choice","Only number!!!","please enter size of Array"};
    final static String[] soutArray = {"-----------------   1. ADD  ------------------------","-----------------   1.1 ADD(INSERT)  ------------------------", "-----------------   2. GET  ------------------------",
            "-----------------   3. REMOVE  ------------------------","-----------------   4. SET  ------------------------",
            "-----------------   5. REVERSE  ------------------------","-----------------   6. SIZE  ------------------------","-----------------   7. INIT  ------------------------","-----------------   8. Sort  ------------------------",
            "-----------------   9. Min & Max  ------------------------"
    };
